    ...
    return (
        <div className="base-div">
            ...
            <div className="others-div">
                ...
                <p className="other-content ani-content">Bootstrap's default utility classes can be found on the official Bootstrap Documentation page. The custom utilities below were created to extend this theme past the default utility classes built into Bootstrap's framework.</p>
                <div>
